...
case class Usage(
  ...
  captureUsageMetadata: Option[CaptureUsageMetadata] = None
)
object Usage {
  ...
  implicit val writes: Writes[Usage] = (
    (__ \ "id").write[String] ~
      ...
      (__ \ "captureUsageMetadata").writeNullable[CaptureUsageMetadata]
  ...
  implicit val reads: Reads[Usage] = (
    (__ \ "id").read[String] ~
      ...
      (__ \ "captureUsageMetadata").readNullable[CaptureUsageMetadata]
    )(Usage.apply _)
}
